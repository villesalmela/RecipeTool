 ...
 * -choiceYNC | question message, YES = 0, NO = 1, CANCEL = 2<br>
 * -choiceOC  | question message, OK = 0, CANCEL = 2
 * 
...
public class Dialogs {
	 ...
	 * Question message -dialog, with title: Attention
	 * @param message The message.
	 * @return 0 = YES<br>2 = CANCEL
	 */
	public static int choiceOC(String message){
		return JOptionPane.showConfirmDialog(null, message, "Attention", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
	}
